...
export function YoutubeDashboard() {
  ...
  const {contents,Refresh}=useMediaContent({type:"youtube"});
      ...
      <main className={`flex-1 transition-all duration-300 md:ml-64 p-4 md:p-6`}>
        <div className={`${modalOpen || shareOpen ? 'opacity-60' : ''}`}>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            <div>
              <h1 className="heading-2 text-blackish">YouTube Content</h1>
              <p className="text-body mt-2">Manage your YouTube videos</p>
            </div>
