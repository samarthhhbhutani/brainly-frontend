        ...
        <div className="bg-zinc-900 h-screen w-screen">
            ...
            <div className="flex justify-center h-full w-full items-center">
                ...
                <div className="flex pt-1 justify-center pb-4 w-full">
                    ...
                    <button className="px-4 py-5 rounded-md font-light justify-between cursor-pointer w-full hover:opacity-80 bg-white flex items-center h-8" type="submit" id="login-with-google-btn" >
